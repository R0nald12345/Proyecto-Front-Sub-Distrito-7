...
import { getDatoCentroDeportivoId,  updateCentroDeportivos } from "../../api/CentroDeportivo";
...
const ActualizarCentroDeportivo = () => {
  ...
  const updateCentroDeportivo=async(e)=>{
    ...
    try {
      ...
      const response = await updateCentroDeportivos(
        id,
        nombre,
        coordenada_x,
        coordenada_y,
...
export default ActualizarCentroDeportivo;
