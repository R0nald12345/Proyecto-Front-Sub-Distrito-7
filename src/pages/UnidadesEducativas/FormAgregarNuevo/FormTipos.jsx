...
import { TiposTurno } from '../../../apiServices/apiServices';
...
const FormTipos = () => {
    ...
    //         try {
    //             const datoTurnos = await TiposTurno();
    //             setTipoColegio(datoTurnos);
    //             console.log('kjhgcesjjceskjl');
    //             console.log(datoTurnos);
    //         } catch (error) {
    //             console.log('Error al Obtener Datos desde Componente FormTipos', error);
    //         }
    //     }
    //     getTipoTurno();
    // }, []);
