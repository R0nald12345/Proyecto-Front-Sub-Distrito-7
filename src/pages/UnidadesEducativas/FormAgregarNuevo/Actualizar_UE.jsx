...
import { ActualizarlUE, createDatoGeneralUE, getDatoGeneralUE } from "../../../api/UnidadesEducativas";
  ...
  useEffect(() => {
    const fetchingDatosColegio = async () => {
      try {
        ...
        console.log("Datos Colegio: ", response);

        setTipoColegio(datoTipoColegio);
      } catch (error) {
        console.log(
          "Error al Obtener Datos desde Componente fetchingDatosColegio",
          error
        );
      }
    };
