...
const FormVistaApoyoGubernamental = ({id}) => {
            ...
            <section className='border border-black/50 rounded-lg px-2 py-3'>
              <div className='w-full'>
                  <ul className='w-full flex bg-white gap-5 mb-3 rounded-xl shadow-lg'>
                    ...
                    <li className=" font-semibold text-start w-1/3 px-3 py-2 ">Nombre Entrega</li>
                    <li className=" font-semibold text-start w-1/3 px-3 py-2 ">Cantidad</li>
                  </ul>

                  <section className="w-full max-h-96 overflow-y-auto"
                    style={{ "scrollbarWidth": "none" }}
                  >
                    <ul className='w-full flex bg-white gap-5 mb-3 rounded-xl shadow-lg'>
                      <li className=" font-semibold text-start w-1/3 px-3 py-2 ">03/04/2024</li>
                      <li className=" font-semibold text-start w-1/3 px-3 py-2 ">Ronald Camino Puma</li>
                      <li className=" font-semibold text-start w-1/3 px-3 py-2 ">40 Sillas</li>
                    </ul>
...
export default FormVistaApoyoGubernamental
