...
import ListaVistaMantenimiento from './ListaVistaMantenimiento';

const FormVistaMantenimiento = ({id}) => {
        ...
        <section className='border border-black/50 rounded-lg px-5 py-3'>
            <div className='w-full'>
                <ul className='grid grid-cols-11 bg-white gap-5 mb-3 rounded-xl shadow-lg'>
                  ...
                  <li className=" font-semibold text-start col-span-3 px-3 py-2 ">Titulo</li>
                  <li className=" font-semibold text-start col-span-2 px-3 py-2 ">Encargado</li>
                  <li className=" font-semibold text-center col-span-3 px-2 py-2">Empresa</li>
                </ul>
            </div>
...
export default FormVistaMantenimiento
