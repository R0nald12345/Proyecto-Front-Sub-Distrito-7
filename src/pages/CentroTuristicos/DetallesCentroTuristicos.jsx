  ...
  return (
    <div className="flex justify-center items-center">
      <form
        ...
        className="bg-gray-100/50 rounded-xl shadow-xl w-[80%] p-3 md:p-8"
      >
        {/* parte Derecho */}
        ...
        <section className="xl:flex gap-5 mt-5 ">
          <section className="xl:w-[40%] md:flex lg:block ">
            ...
            <textarea
              className="w-full mt-1 h-[66%] border-gray-400 border-2 rounded-xl py-1 px-2 bg-gray-200 overflow-y-scroll"
          ...
          <section className="w-full xl:w-[60%] ">
            {/* Parte Superior*/}
            <section className="block border-2 rounded-xl md:flex gap-5 ">
