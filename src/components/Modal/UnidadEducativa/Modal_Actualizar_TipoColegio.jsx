...
import Lista_TipoColegio from "../../Listas/UnidadesEducativas/ListaTipoColegio";

const Modal_Actualizar_TipoColegio = ({
  open,
  onClose,
}) => {
    ...
    <>
      <div className="fixed inset-0 bg-black bg-opacity-50 z-10 flex items-center justify-center">
        <div className="max-w-lg w-11/12 max-h-[90vh] bg-white/60 shadow-2xl rounded-2xl p-5">
          ...
          <h2 className="text-3xl font-bold text-center">Lista Tipo Colegio</h2>
...
export default Modal_Actualizar_TipoColegio;
