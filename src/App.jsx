    ...
    <div className="grid lg:grid-cols-4 xl:grid-cols-6 min-h-screen">
        ...
        <main className="lg:col-span-3 xl:col-span-5 bg-gray-200 p-8 h-[100vh] overflow-y-scroll">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 mt-10 gap-8">
            ...
            <div className="bg-primary-100 p-8 rounded-xl text-gray-300 flex flex-col gap-6">
              ...
              <h4 className="text-3xl">Earnings</h4>
                ...
                <span className="py-1 px-3 bg-primary-900/50 rounded-full">+10% since last month</span>
            </div>
            {/* Card 2 */}
            <div className="p-4 bg-white rounded-xl flex flex-col justify-between gap-4 drop-shadow-2xl">
              ...
              <div className="flex items-center gap-4 bg-primary-100/30 rounded-xl p-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 font-semibold">In top 30%</p>
                </div>
              </div>
              ...
              <div className=" bg-primary-100/30 rounded-xl p-4">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 font-semibold">8 this month</p>
                  </div>
                </div>
            ...
            <div className="col-span-1 md:col-span-2 flex flex-col justify-between">
              ...
              <div className="bg-white p-8  rounded-xl shadow-2xl">
                  ...
                  <div className="flex items-center gap-4 mb-4">
                      ...
                      />
                      <div>
                        <h3 className="font-bold">Personal Brading  Project</h3>
                        <p className="text-gray-500">5 days remaining</p>
                      </div>
                  </div>
                  <div className="flex justify-end">
                      <a href="#" className="hover:text-primary-300 transition-colors hover:underline" >See all projects</a>
                  </div>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 mt-10 gap-8">
              <div >
                <h1 className="text-2xl font-bold mb-8">Recent  Invoice</h1>
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-4 items-center gap-4 mb-4">
                        <div className="col-span-2 flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-gray-500">JO Hoilding</p>
                          </div>
                        </div>
                        <div>
                ...
                <div className="bg-primary-900 text-gray-300 p-8 rounded-xl shadow-2xl flex items-center justify-between flex-wrap xl:flex-nowrap  gap-8">
                    ...
                    <div className="w-full xl:w-auto">
                      <button className="bg-primary-100 py-2 px-6 rounded-xl text-white border border-white w-full">Join Now</button>
                    </div>
                </div>
              ...
              <div>
                <h1 className="text-2xl font-bold mb-8">Recommended projects</h1>
                <div className="bg-white p-8 rounded-xl shadow-2xl mb-8 gap-4">
                  ...
                  <div className="mb-6">
                      <h5 className="text-lg font-bold">Nedd a dessigner to form branding essentials for my bussiness.</h5>
                      <p className="text-gray-500">Looking for a talented brad designer to create all the
                         breading materials for my startup
                      </p>
